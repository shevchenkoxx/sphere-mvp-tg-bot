...
from adapters.telegram.handlers import start, onboarding, onboarding_v2, onboarding_audio, events, matches, profile_edit, sphere_city, personalization, meetup, vibe_check, story_onboarding
...
routers = [
    *onboarding_routers,  # Must be first to handle state-specific callbacks
    ...
    story_onboarding.router,  # Story Onboarding - pre-onboarding flow, must be before start.py
